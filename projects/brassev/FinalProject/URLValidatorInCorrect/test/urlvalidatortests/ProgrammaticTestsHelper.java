...
public class ProgrammaticTestsHelper extends TestCase {
	...
	/* Public methods */
	/* Constructor */
	public ProgrammaticTestsHelper(String[] testSchemes, String[] testAuthorities,
	...
	/* Combine all the test URLs bits in this ProgrammaticTestsHelper object */
	...
	public static void start(String[] argv) {
	   ...
	   /* ProgrammaticTestsHelper mostly serves to combine strings */
	   /* I should probably refactor the test loop below to its own function */
	   ProgrammaticTestsHelper test = new ProgrammaticTestsHelper(testSchemes, testAuthorities,
